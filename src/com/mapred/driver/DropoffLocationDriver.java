...
import com.mapred.mapper.DropoffLocationMapper;
...
public class DropoffLocationDriver {
 ...
 public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(DropoffLocationDriver.class);
    ...
    job.setMapperClass(DropoffLocationMapper.class);
